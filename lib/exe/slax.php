...
function jquery_out() {
    ...
    $files = array(
        DOKU_INC . 'lib/scripts/slax/skylark-requirejs.js',        
        DOKU_INC . 'lib/scripts/slax/require.text.js',
        DOKU_INC . 'lib/scripts/slax/require.i18n.js',
        DOKU_INC . 'slax/dist/uncompressed/slax-skydoku-all.js',
        DOKU_INC . 'lib/scripts/slax/init.js'
    );
    $cache_files = $files;
