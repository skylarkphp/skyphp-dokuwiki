<?php
/**
 * Options for the interactive plugin
 */

$conf['automatic']    = 0;   // interactive section on every page by default
...
$conf['visibilityButton'] = 0; // show/hide button to hide the interactive section
