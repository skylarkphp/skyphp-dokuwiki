...
/**
 * Class helper_plugin_interactive
 */
class helper_plugin_interactive extends DokuWiki_Plugin {
    ...
    function getMethods() {
        ...
        $result[] = array(
                'name'   => 'td',
                'desc'   => 'returns the link to the interactive section with number of comments',
                'params' => array(
                    'id' => 'string',
        ...
        $result[] = array(
                'name'   => 'getThreads',
                'desc'   => 'returns pages with interactive sections, sorted by recent comments',
                'params' => array(
                    'namespace' => 'string',
     ...
     */
    function th() {
        return $this->getLang('interactive');
    }

    /**
     * Returns the link to the interactive section of a page
     *
     * @param string $id
     * @param null|int $num
     * @return string
    ...
    function getThreads($ns, $num = null, $skipEmpty = false) {
        ...
        foreach ($items as $item) {
            ...
            if($skipEmpty == 'y' && $number == 0) continue; // skip if interactive is empty and flag is set
    ...
    /* ---------- Changelog function adapted for the Interactive Plugin ---------- */
    ...
    function _handleRecentComment($line, $ns, &$seen) {
        ...
        // check if interactive is turned off
