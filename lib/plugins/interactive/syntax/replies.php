 ...
 */
class syntax_plugin_interactive_replies extends DokuWiki_Syntax_Plugin {
    ...
    function render($mode, Doku_Renderer $renderer, $data) {
        ...
        if ($mode == 'metadata') {
            ...
            $renderer->meta['plugin_interactive'] = array('status' => $status, 'title' => $title);
        }
        return true;
    }
}
