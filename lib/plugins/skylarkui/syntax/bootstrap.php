...
class syntax_plugin_skylarkui_bootstrap extends DokuWiki_Syntax_Plugin {
  ...
  function checkAttributes($attributes = array()) {
    ...
    if ($ACT == 'preview') {
      $msg_title = sprintf('<strong>Bootstrap Wrapper - %s</strong>',
                            ucfirst(str_replace('syntax_plugin_skylarkui_',
                                                '', get_class($this))));
    }
  ...
  function connectTo($mode) {
    $this->Lexer->addEntryPattern($this->pattern_start, $mode, 'plugin_skylarkui_'.$this->getPluginComponent());
  }


  public function postConnect() {
    $this->Lexer->addExitPattern($this->pattern_end, 'plugin_skylarkui_'.$this->getPluginComponent());
    $this->Lexer->addPattern($this->header_pattern, 'plugin_skylarkui_'.$this->getPluginComponent());
  }
