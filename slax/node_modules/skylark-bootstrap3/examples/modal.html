...
<div class="container">
  ...
  <div id="myModal2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" data-container="#container1">
...
<div id="container1" style="position:relative;height:400px;background:blue">
</div>

<!-- JavaScript Includes -->
<script type="text/javascript" src="./requirejs/require.js" data-main="./config.js"></script>
...
<script>
    var initPage = function ($,slangx) {
        ...
        $(document).on('click.bs.modal.data-api', '[data-toggle="modal"]', function (e) {            
            ...
            var option  = $target.data('bs3.modal') ? 'toggle' : slangx.mixin({ remote: !/#/.test(href) && href }, $target.data(), $this.data())
