    ...
    <div class="container">
      <div class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
          <div class="navbar-header">
            <a class="navbar-brand" href="javascript:void(0)"><strong>skylark-jszip</strong></a>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <script type="text/javascript" src="./skylark-jquery-all.js"></script>
          <script type="text/javascript" src="./skylark-io-caches.js"></script>

          <!-- Latest compiled and minified JavaScript -->
          <script src="http://netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js"></script>

          <script type="text/javascript" src="../dist/uncompressed/skylark-jszip.js"></script>
          ...
          var lfs;
          skylarkjs.io.caches.LocalFileSystem.request(1024*1024*10,true).then(function(fs){
              lfs = fs;
          });
          ...
          $("#file").on("change", function(evt) {
              ...
              function handleFile(f) {
                  ...
                  skylarkjs.intg.jszip(f) .then(function(zip) {
